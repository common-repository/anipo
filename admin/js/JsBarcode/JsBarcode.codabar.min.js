...
!function (t) {
  ...
  e.InvalidInputException = a, e.InvalidElementException = s, e.NoElementException = u
}, function (t, e, n) {
  "use strict";
  ...
  function o(t, e, n) {
    for (var o = 0; o < t.length; o++) {
      var a, s = t[o], f = (0, c.default)(e, s.options);
      a = f.displayValue ? u(s.text, f, n) : 0;
      var l = s.data.length * f.width;
      s.width = Math.ceil(Math.max(a, l)), s.height = r(s, f), s.barcodePadding = i(a, l, f)
    }
  }
  ...
  e.getMaximumHeightOfEncodings = s, e.getEncodingHeight = r, e.getBarcodePadding = i, e.calculateEncodingAttributes = o, e.getTotalWidthOfEncodings = a
}, function (t, e, n) {
  "use strict";
  Object.defineProperty(e, "__esModule", {value: !0});
  var r = n(12);
  ...
  function i(t) {
    ...
    if (t && "object" === (void 0 === t ? "undefined" : s(t)) && !t.nodeName) return {
      element: t,
  ...
  }, u = n(13), f = r(u), c = n(15), l = r(c), d = n(1);
  e.default = i
}, function (t, e, n) {
  "use strict";
  ...
  var s = n(5), u = r(s), f = n(0), c = r(f), l = n(9), d = r(l), h = n(7), p = r(h), g = n(8), v = r(g), y = n(2),
    b = r(y), m = n(6), w = r(m), _ = n(1), x = n(3), O = r(x), A = function () {
    }, E = function (t, e, n) {
      var r = new A;
  ...
  for (var P in u.default) u.default.hasOwnProperty(P) && function (t, e) {
    A.prototype[e] = A.prototype[e.toUpperCase()] = A.prototype[e.toLowerCase()] = function (n, r) {
      var o = this;
  ...
  A.prototype.options = function (t) {
    ...
    if (this._renderProperties) {
      ...
      for (var e in this._renderProperties) {
        ...
        "auto" == n.format && (n.format = o()), this._errorHandler.wrapBarcodeCall(function () {
          var e = n.value, r = u.default[n.format.toUpperCase()], o = i(e, r, n);
          a(t, o, n)
        })
      }
    }
    ...
    return this
  }, A.prototype._defaults = O.default, "undefined" != typeof window && (window.JsBarcode = E), "undefined" != typeof jQuery && (jQuery.fn.JsBarcode = function (t, e) {
    var n = [];
  ...
  var a = function () {
    ...
    function e(t, n) {
      ...
      var o = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t.toUpperCase(), n));
  ...
  Object.defineProperty(e, "__esModule", {value: !0});
  var i = n(14), o = r(i), a = n(17), s = r(a), u = n(16), f = r(u);
  e.default = {CanvasRenderer: o.default, SVGRenderer: s.default, ObjectRenderer: f.default}
}, function (t, e, n) {
  "use strict";
  ...
  var i = function () {
    ...
    return t && t.__esModule ? t : {default: t}
  }(o), s = n(4), u = "http://www.w3.org/2000/svg", f = function () {
    function t(e, n, i) {
    ...
    return i(t, [{
      ...
      key: "prepareSVG", value: function () {
        ...
        (0, s.calculateEncodingAttributes)(this.encodings, this.options);
        var t = (0, s.getTotalWidthOfEncodings)(this.encodings), e = (0, s.getMaximumHeightOfEncodings)(this.encodings),
      ...
      key: "drawSvgBarcode", value: function (t, e, n) {
        ...
        for (var o = 0, a = 0, s = 0; s < i.length; s++) a = s * e.width + n.barcodePadding, "1" === i[s] ? o++ : o > 0 && (this.drawRect(a - e.width * o, r, e.width * o, e.height, t), o = 0);
