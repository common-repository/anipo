...
!function (t) {
  ...
  var u = function () {
  ...
  }(), s = n(1), f = n(2), c = r(f), l = n(0), d = r(l), p = function (t) {
    function e(t, n) {
      o(this, e);
    ...
    return a(e, t), u(e, [{
      ...
      key: "encodeGuarded", value: function () {
        ...
        return [{data: s.SIDE_BIN, options: e}, {
      ...
      key: "encodeFlat", value: function () {
        return {
          data: [s.SIDE_BIN, this.leftEncode(), s.MIDDLE_BIN, this.rightEncode(), s.SIDE_BIN].join(""),
          text: this.text
        }
      }
    }]), e
  ...
  e.checksum = u;
  var f = n(2), c = r(f), l = n(0), d = r(l), p = function (t) {
    function e(t, n) {
    ...
    return a(e, t), s(e, [{
      ...
      key: "flatEncoding", value: function () {
        var t = "";
        return t += "101", t += (0, c.default)(this.data.substr(0, 6), "LLLLLL"), t += "01010", t += (0, c.default)(this.data.substr(6, 6), "RRRRRR"), t += "101", {
          data: t,
          text: this.text
        }
      }
      ...
      key: "guardedEncoding", value: function () {
        ...
        return this.displayValue && t.push({
          ...
          data: "101" + (0, c.default)(this.data[0], "L"),
          options: {height: this.guardHeight}
        }), t.push({
          data: (0, c.default)(this.data.substr(1, 5), "LLLLL"),
          ...
          data: (0, c.default)(this.data.substr(6, 5), "RRRRR"),
          text: this.text.substr(6, 5),
          options: {fontSize: this.fontSize}
        }), t.push({
          data: (0, c.default)(this.data[11], "R") + "101",
          options: {height: this.guardHeight}
  ...
  Object.defineProperty(e, "__esModule", {value: !0});
  var r = n(21);
  e.default = {EAN13: r.EAN13, EAN8: r.EAN8, EAN5: r.EAN5, EAN2: r.EAN2, UPC: r.UPC}
}, function (t, e, n) {
  "use strict";
  ...
  }, s = n(22), f = r(s), c = n(24), l = r(c), d = n(4);
  e.default = o
}, function (t, e, n) {
  "use strict";
  ...
  var u = n(10), s = r(u), f = n(3), c = r(f), l = n(14), d = r(l), p = n(12), h = r(p), g = n(13), v = r(g), y = n(5),
    b = r(y), _ = n(11), O = r(_), E = n(4), m = n(6), w = r(m), x = function () {
    }, P = function (t, e, n) {
      var r = new x;
      if (void 0 === t) throw Error("No element to render on was provided.");
      return r._renderProperties = (0, v.default)(t), r._encodings = [], r._options = w.default, r._errorHandler = new O.default(r), void 0 !== e && (n = n || {}, n.format || (n.format = i()), r.options(n)[n.format](e, n).render()), r
    };
  ...
  x.prototype.options = function (t) {
    ...
    return this
  }, x.prototype._defaults = w.default, "undefined" != typeof window && (window.JsBarcode = P), "undefined" != typeof jQuery && (jQuery.fn.JsBarcode = function (t, e) {
    var n = [];
  ...
  var a = function () {
    ...
    return i(e, t), a(e, [{
      ...
      key: "leftEncode", value: function () {
        var t = this.data.substr(1, 6), n = s.EAN13_STRUCTURE[this.data[0]];
  ...
  var u = function () {
    ...
    return a(e, t), u(e, [{
      ...
      key: "encode", value: function () {
        var t = s.EAN2_STRUCTURE[parseInt(this.data) % 4];
        return {data: "1011" + (0, c.default)(this.data, t, "01"), text: this.text}
      }
    }]), e
  }(d.default);
  e.default = p
  ...
  var a = function () {
    ...
    function e(t, n) {
      return r(this, e), -1 !== t.search(/^[0-9]{7}$/) && (t += c(t)), o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n))
    }
  ...
  var s = function () {
    ...
    }(), f = n(2), c = r(f), l = n(0), d = r(l), p = n(8),
    h = ["XX00000XXX", "XX10000XXX", "XX20000XXX", "XXX00000XX", "XXXX00000X", "XXXXX00005", "XXXXX00006", "XXXXX00007", "XXXXX00008", "XXXXX00009"],
    g = [["EEEOOO", "OOOEEE"], ["EEOEOO", "OOEOEE"], ["EEOOEO", "OOEEOE"], ["EEOOOE", "OOEEEO"], ["EOEEOO", "OEOOEE"], ["EOOEEO", "OEEOOE"], ["EOOOEE", "OEEEOO"], ["EOEOEO", "OEOEOE"], ["EOEOOE", "OEOEEO"], ["EOOEOE", "OEEOEO"]],
    v = function (t) {
      function e(t, n) {
        o(this, e);
        var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
      ...
      return a(e, t), s(e, [{
        ...
        key: "encodeMiddleDigits", value: function () {
          var t = this.upcA[0], e = this.upcA[this.upcA.length - 1], n = g[parseInt(e)][parseInt(t)];
  ...
  var o = n(16), i = r(o), a = n(19), u = r(a), s = n(18), f = r(s), c = n(17), l = r(c), d = n(8), p = r(d), h = n(20),
    g = r(h);
  e.EAN13 = i.default, e.EAN8 = u.default, e.EAN5 = f.default, e.EAN2 = l.default, e.UPC = p.default, e.UPCE = g.default
}, function (t, e, n) {
  "use strict";
  ...
  Object.defineProperty(e, "__esModule", {value: !0});
  var o = n(23), i = r(o), a = n(26), u = r(a), s = n(25), f = r(s);
  ...
  var o = function () {
    ...
    return t && t.__esModule ? t : {default: t}
  }(i), u = n(9), s = "http://www.w3.org/2000/svg", f = function () {
    function t(e, n, o) {
