...
!function (t) {
  ...
  var a = function () {
    ...
    return o(e, t), a(e, [{
      ...
      key: "encode", value: function () {
        ...
        return {data: u.START_BIN + e + u.END_BIN, text: this.text}
      }
    }, {
  ...
  function o(t, e, n) {
    for (var o = 0; o < t.length; o++) {
      var a, u = t[o], f = (0, c.default)(e, u.options);
  ...
  Object.defineProperty(e, "__esModule", {value: !0});
  var r = n(15);
  e.default = {ITF: r.ITF, ITF14: r.ITF14}
}, function (t, e, n) {
  "use strict";
  ...
  }, s = n(16), f = r(s), c = n(18), l = r(c), d = n(1);
  e.default = i
}, function (t, e, n) {
  "use strict";
  ...
  var u = n(6), s = r(u), f = n(0), c = r(f), l = n(10), d = r(l), p = n(8), h = r(p), g = n(9), v = r(g), y = n(2),
    b = r(y), m = n(7), _ = r(m), w = n(1), x = n(3), O = r(x), P = function () {
    }, E = function (t, e, n) {
      var r = new P;
      if (void 0 === t) throw Error("No element to render on was provided.");
      return r._renderProperties = (0, v.default)(t), r._encodings = [], r._options = O.default, r._errorHandler = new _.default(r), void 0 !== e && (n = n || {}, n.format || (n.format = o()), r.options(n)[n.format](e, n).render()), r
    };
  E.getModule = function (t) {
    return s.default[t]
  };
  for (var j in s.default) s.default.hasOwnProperty(j) && function (t, e) {
  ...
  P.prototype.options = function (t) {
    ...
    if (this._renderProperties) {
      ...
      for (var e in this._renderProperties) {
        ...
        "auto" == n.format && (n.format = o()), this._errorHandler.wrapBarcodeCall(function () {
          var e = n.value, r = s.default[n.format.toUpperCase()], o = i(e, r, n);
          a(t, o, n)
        })
      }
    }
    ...
    return this
  }, P.prototype._defaults = O.default, "undefined" != typeof window && (window.JsBarcode = E), "undefined" != typeof jQuery && (jQuery.fn.JsBarcode = function (t, e) {
    var n = [];
  ...
  var a = function () {
    ...
    function e(t, n) {
      return r(this, e), -1 !== t.search(/^[0-9]{13}$/) && (t += f(t)), i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n))
    }

    return o(e, t), a(e, [{
      key: "valid", value: function () {
        return -1 !== this.data.search(/^[0-9]{14}$/) && +this.data[13] === f(this.data)
      }
    }]), e
  }(s.default);
  e.default = c
  ...
  var i = n(4), o = r(i), a = n(13), u = r(a);
  e.ITF = o.default, e.ITF14 = u.default
}, function (t, e, n) {
  "use strict";
  ...
  Object.defineProperty(e, "__esModule", {value: !0});
  var i = n(17), o = r(i), a = n(20), u = r(a), s = n(19), f = r(s);
  e.default = {CanvasRenderer: o.default, SVGRenderer: u.default, ObjectRenderer: f.default}
}, function (t, e, n) {
  "use strict";
  ...
  var i = function () {
    ...
    return t && t.__esModule ? t : {default: t}
  }(o), u = n(5), s = "http://www.w3.org/2000/svg", f = function () {
    function t(e, n, i) {
    ...
    return i(t, [{
      ...
      key: "prepareSVG", value: function () {
        ...
        var t = (0, u.getTotalWidthOfEncodings)(this.encodings), e = (0, u.getMaximumHeightOfEncodings)(this.encodings),
      ...
      key: "drawRect", value: function (t, e, n, r, i) {
